const { xml, whenReady } = owl; // see https://github.com/odoo/owl/blob/master/README.md
...
const {
  ...
  compatibility, // this is an owl3 compatibility layer, required during the transition from owl2 to owl3, see https://odoo.github.io/owl/documentation/v3/owl/migration_owl2_to_owl3.html
} = o_spreadsheet; // they are exposed on the global o_spreadsheet object on window (in the browser)

const { App, Component } = compatibility;
