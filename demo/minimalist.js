const { xml, Component, whenReady, onMounted } = owl; // see https://github.com/odoo/owl/blob/master/README.md
...
let startTime; // we will use this to measure the loading time of the spreadsheet
...
class Demo extends Component {
  setup() {
    ...
    onMounted(() => console.log("Mounted: ", Date.now() - startTime)); // when the component is mounted, we will log the time it took to create it
  }

  createModel() {
    //let emptySpreadsheet = {}; // this is an empty spreadsheet, you can use it to create a new spreadsheet from scratch
    let startingSpreadsheet = {
    ...
    this.model = new Model(startingSpreadsheet, {
      mode: "normal", // in nomal mode the spreadsheet is editable, alternatives are "readonly" and "dashboard"
