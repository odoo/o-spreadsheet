...
export default tseslint.config(eslint.configs.recommended, ...tseslint.configs.recommended, {
  rules: {
    ...
    "@typescript-eslint/no-non-null-asserted-optional-chain": "off", // to investigate, it probably is a mistake though
    "@typescript-eslint/ban-types": "off", // interesting read -> some types we choose are not bad but could be better chosen
    "@typescript-eslint/no-this-alias": "off", // we reuse a reserved word without reason (could use self)
