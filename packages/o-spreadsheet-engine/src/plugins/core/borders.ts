...
function internal(border: BorderDescr | undefined | null): BorderDescrInternal {
  if (!border) {
    return EMPTY_BORDER;
  }
...
function external(border: BorderDescr | undefined | null): BorderDescrInternal {
  if (!border) {
    return EMPTY_BORDER;
  }
...
function both(border: BorderDescr | undefined | null): BorderDescrInternal {
  if (!border) {
    return EMPTY_BORDER;
  }
