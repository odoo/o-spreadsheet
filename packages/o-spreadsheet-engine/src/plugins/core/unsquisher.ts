    ...
    for (const { key } of keys) {
      ...
      switch (strategy) {
        ...
        case "NOT_A_FORMULA":
          for (const cell of positionsOfKey) {
            yield {
              position: { col: cell[0], row: cell[1] },
        ...
        case "COMBINE_OFFSET":
          ...
          this.previousOffset.N = currentOffset.N ? currentOffset.N : this.previousOffset.N;
          this.previousOffset.S = currentOffset.S ? currentOffset.S : this.previousOffset.S;
          this.previousOffset.R = currentOffset.R ? currentOffset.R : this.previousOffset.R;
          for (const cell of positionsOfKey) {
