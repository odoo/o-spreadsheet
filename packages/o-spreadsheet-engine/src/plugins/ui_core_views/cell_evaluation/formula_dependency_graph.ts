...
import { ForestDependencyGraph } from "./simple_interval_tree";

export { ForestDependencyGraph as FormulaDependencyGraph };
...
//   private readonly bySheet: Record<UID, ForestDependencyGraph> = {};

//   constructor(data: RTreeItem<BoundedRange>[] = []) {
//     for (const item of data) {
//       const { sheetId, zone } = item.data;
//       const graph = this.bySheet[sheetId] || (this.bySheet[sheetId] = new ForestDependencyGraph());
...
//       if (!graph) {
//         graph = new ForestDependencyGraph();
...
//         continue;
//       }
//       const impactedZones = graph.getRangeDependents([range]);
 ...
 */
export class FormulaDependencyGraphVV {
