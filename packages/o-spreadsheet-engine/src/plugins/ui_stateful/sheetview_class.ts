...
export class ViewportCollection {
  ...
  getActiveMainViewport(sheetId: UID): Viewport {
   ...
   */
  getActiveSheetScrollInfo(sheetId: UID): SheetDOMScrollInfo {
    // ADRM TODO: rename "active" thingies
  ...
  getEdgeScrollCol(sheetId: UID, x: number, previousX: number, startingX: number): EdgeScrollInfo {
    ...
    const currentOffsetX = this.getActiveSheetScrollInfo(sheetId).scrollX;
  ...
  getEdgeScrollRow(sheetId: UID, y: number, previousY: number, startingY: number): EdgeScrollInfo {
    ...
    const currentOffsetY = this.getActiveSheetScrollInfo(sheetId).scrollY;
  ...
  getAllActiveViewportsZonesAndRect(sheetId: UID): { zone: Zone; rect: Rect }[] {
  ...
  getColIndexLeftOfMainViewport(sheetId: UID, x: Pixel): HeaderIndex {
    ...
    let col = this.getActiveMainViewport(sheetId).left;
    let colStart =
      -this.getActiveSheetScrollInfo(sheetId).scrollX -
  ...
  getRowIndexTopOfMainViewport(sheetId: UID, y: Pixel): HeaderIndex {
    ...
    let row = this.getActiveMainViewport(sheetId).top;
    let rowStart =
      -this.getActiveSheetScrollInfo(sheetId).scrollY -
  ...
  getVisibleFigures(sheetId: UID): FigureUI[] {
    ...
    const { scrollX, scrollY } = this.getActiveSheetScrollInfo(sheetId);
