...
export type ChartWithDataSetDefinition = Extract<
  ChartDefinition,
  { dataSets: DataSetStyling; labelRange?: string; humanize?: boolean }
>;
...
export type DataSetStyling = Record<UID, CustomizedDataSet>;
...
export interface ChartRangeDataSource {
  readonly dataSets: { id: UID; dataRange: string }[];
}
