...
export class BottomBarStatistic extends OSComponent {
  ...
  get isDataAnalysisOpen(): boolean {
    return (
      ...
      (this.sidePanelStore.secondaryPanel?.componentTag === "DataAnalysisPanel" &&
        this.sidePanelStore.isSecondaryPanelOpen)
    );
  }
