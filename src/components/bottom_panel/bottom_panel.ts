...
import { BottomPanelStore } from "./bottom_panel_store";
...
export class BottomPanel extends Component<{}, SpreadsheetChildEnv> {
  static template = "o-spreadsheet-mobile_BottomPanel";
  static props = {};
  sidePanelStore!: Store<BottomPanelStore>;
  spreadsheetRect = useSpreadsheetRect();

  setup() {
    this.sidePanelStore = useStore(BottomPanelStore);
    useEffect(
      (isOpen) => {
        if (!isOpen) {
