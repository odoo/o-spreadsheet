...
export type BottomPanelState = OpenBottomPanel | ClosedSidePanel;

export const DEFAULT_SIDE_PANEL_SIZE = 350;
export const MIN_SHEET_VIEW_WIDTH = 150;

export class BottomPanelStore extends SpreadsheetStore {
  ...
  private computeState(componentTag: string, panelProps: SidePanelProps): BottomPanelState {
