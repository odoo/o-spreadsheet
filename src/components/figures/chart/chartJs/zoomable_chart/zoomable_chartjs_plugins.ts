...
/*
 * This plugin draws a shaded area on the master chart to indicate the current sliding window, ie the
...
export const slidingWindowPlugin: Plugin = {
  id: "slidingWindowPlugin",
...
declare module "chart.js" {
  interface PluginOptionsByType<TType extends ChartType> {
    slidingWindowPlugin?: CurrentAreaPluginOptions;
  }
}
