...
export class ChartDashboardMenu extends Component<Props, SpreadsheetChildEnv> {
  ...
  static props = { chartId: String, displayTypeSwitcher: { type: Boolean, optional: true } };
  static defaultProps = { displayTypeSwitcher: true };
  ...
  getMenuItems(): MenuItem[] {
    ...
    if (this.props.displayTypeSwitcher) {
      items.push(...this.store.changeChartTypeMenuItems);
    }
    return items;
  }
