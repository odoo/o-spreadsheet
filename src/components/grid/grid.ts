...
import { getPastablePluginClipBoardContent } from "../../helpers/clipboard/clipboard_helpers";
...
export class Grid extends Component<Props, SpreadsheetChildEnv> {
  ...
  async paste(ev: ClipboardEvent) {
    ...
    const clipboardContent = getPastablePluginClipBoardContent(osClipboard.content);
