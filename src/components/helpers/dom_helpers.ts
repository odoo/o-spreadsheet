...
export function getSpreadsheetAsBase64() {
  try {
    const container = document.querySelector<HTMLElement>(".o-spreadsheet")!;
    ...
    // Collect all canvases and figure images
    const canvases = [...container.querySelectorAll("canvas")];
    const images = [...container.querySelectorAll<HTMLImageElement>(".o-figure img")];

    // Collect all canvases inside the container, put the figures at the end
    // to ensure they are drawn on top of the background
