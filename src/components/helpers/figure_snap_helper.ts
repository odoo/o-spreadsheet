...
export function snapForMove(
  ...
  const aggregate = rectUnion(...figuresToSnap);
  ...
  return { snapResult: figuresToSnap, verticalSnapLine, horizontalSnapLine };
}
...
export function snapForResize(
  ...
  return { snapResult: figureToSnap, verticalSnapLine, horizontalSnapLine };
}
