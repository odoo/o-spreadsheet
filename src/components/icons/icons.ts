...
export const CARET_DOWN: ImageSVG = {
  width: 512,
  height: 512,
  paths: [{ fillColor: TEXT_BODY_MUTED, path: "M96 176 h320 l-160 160" }],
};
export const CHECKBOX_UNCHECKED: ImageSVG = {
  width: 17,
  height: 17,
  paths: [{ fillColor: GRAY_300, path: "M3 0 h14 v14 h-14 M4 1 v12 h12 v-12" }],
};
...
export const CHECKBOX_CHECKED: ImageSVG = {
  ...
  // paths: [{ fillColor: GRAY_300, path: "M0 0 h512 v512 h-512" }],
};
