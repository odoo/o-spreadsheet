...
export class GenericChartConfigPanel extends Component<Props, SpreadsheetChildEnv> {
  ...
  setup() {
    ...
    onWillUpdateProps((nextProps: Props) => {
      if (this.dataSets.join() !== nextProps.definition.dataSets.join()) {
        this.dataSets = nextProps.definition.dataSets;
        this.labelRange = nextProps.definition.labelRange;
        this.datasetOrientation = this.computeDatasetOrientation();
      }
    });
  }
  ...
  getDatasetOrientation() {
    return this.datasetOrientation;
  }
