...
interface Props {
  ...
  canUpdateChart: (figureID: UID, definition: TimeMatrixChartDefinition) => DispatchResult;
  updateChart: (figureId: UID, definition: TimeMatrixChartDefinition) => DispatchResult;
}
