...
export const CfTerms = {
  Errors: {
    [CommandResult.InvalidRange]: (range) => _t("The range '%s' is invalid", range),
    ...
    [CommandResult.ValueCellIsInvalidFormula]: (formula) => _t("%s is an invalid formula", formula),
    [CommandResult.TargetOutOfSheet]: (range) =>
      _t("The range %s cannot target out of the sheet.", range),
