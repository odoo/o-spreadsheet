...
export const CHOOSECOLS = {
  ...
  args: [
    ...
    arg(
      ...
      _t("The column indexes of the columns to be returned.")
    ),
  ],
...
export const CHOOSEROWS = {
  ...
  args: [
    ...
    arg(
      ...
      _t("The row indexes of the rows to be returned.")
    ),
  ],
...
export const FLATTEN = {
  ...
  args: [arg("range (any, range<any>, repeating)", _t("The ranges to flatten."))],
...
export const HSTACK = {
  ...
  args: [arg("range (any, range<any>, repeating)", _t("The ranges to be appended."))],
  compute: function (...ranges: Arg[]): Matrix<FunctionResultObject> {
...
export const SUMPRODUCT = {
  ...
  args: [
    arg(
      ...
      _t(
        "The ranges whose entries will be multiplied with corresponding entries in the other ranges."
      )
    ),
  ],
