...
import { DAY_COUNT_CONVENTIONS } from "./helper_financial";
...
export const WEEKDAY = {
  ...
  compute: function (
    ...
    if (!(1 <= _type && _type <= 3) && !(11 <= _type && _type <= 17)) {
      return new EvaluationError(
        _t("The type (%s) must be between 1 and 7 or between 11 and 17.", _type)
      );
    }
    switch (_type) {
      case 1:
  ...
  args: [
    ...
    arg(
      ...
      [
        ...
        { value: 11, label: "Monday" },
        { value: 12, label: "Tuesday" },
        { value: 13, label: "Wednesday" },
        { value: 14, label: "Thursday" },
        { value: 15, label: "Friday" },
        { value: 16, label: "Saturday" },
        { value: 17, label: "Sunday" },
