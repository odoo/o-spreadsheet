  ...
  compute: function (
    ...
    for (const ref of refs) {
      ...
      for (let row = top; row <= bottom; row++) {
        ...
        if (!takeHiddenCells && hiddenRows.includes(row)) continue;
    ...
    return subtotalFunctionByCode[code].bind(this)([evaluatedCellToKeep]);
  },
} satisfies AddFunctionDescription;
