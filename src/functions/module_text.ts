...
export const CONCATENATE = {
  ...
  args: [arg("string (string, range<string>, repeating)", _t("Strings to append in sequence."))],
...
export const JOIN = {
  ...
  args: [
    ...
    arg(
      ...
      _t("Values to be appended using delimiter.")
    ),
  ],
...
export const TEXTJOIN = {
  ...
  args: [
    ...
    arg("texts (string, range<string>, repeating)", _t("Text items to join.")),
  ],
  compute: function (
    delimiter: Maybe<FunctionResultObject>,
