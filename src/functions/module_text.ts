...
const TEXTAFTER_DEFAULT_INSTANCE = 1;
const TEXTAFTER_DEFAULT_MATCH_MODE = 0;
const TEXTAFTER_DEFAULT_MATCH_END = 0;
...
export const TEXTAFTER = {
  ...
  args: [
    ...
    arg(
      `instance_num (number, default=${TEXTAFTER_DEFAULT_INSTANCE})`,
      _t("The desired occurrence of the delimiter. A negative number searches from the end.")
    ),
    arg(
      `match_mode (number, default=${TEXTAFTER_DEFAULT_MATCH_MODE})`,
      _t("0 = case-sensitive, 1 = case-insensitive.")
    ),
    arg(
      `match_end (number, default=${TEXTAFTER_DEFAULT_MATCH_END}))`,
      _t("Wether to treat the end of text as a delimiter.")
    ),
    arg(
  ...
  compute: function (
    ...
    matchIndex: Maybe<FunctionResultObject> = { value: TEXTAFTER_DEFAULT_INSTANCE },
    matchMode: Maybe<FunctionResultObject> = { value: TEXTAFTER_DEFAULT_MATCH_MODE },
    matchEnd: Maybe<FunctionResultObject> = { value: TEXTAFTER_DEFAULT_MATCH_END },
