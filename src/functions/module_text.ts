...
export const CHAR = {
  ...
  returns: ["STRING"],
  compute: function (tableNumber: Maybe<Data>): string {
...
export const CLEAN = {
  ...
  returns: ["STRING"],
  compute: function (text: Maybe<Data>): string {
...
export const CONCATENATE = {
  ...
  returns: ["STRING"],
  compute: function (...values: Arg[]): string {
...
export const EXACT = {
  ...
  returns: ["BOOLEAN"],
  compute: function (string1: Maybe<Data>, string2: Maybe<Data>): boolean {
...
export const FIND = {
  ...
  returns: ["NUMBER"],
  compute: function (
    searchFor: Maybe<Data>,
    textToSearch: Maybe<Data>,
    startingAt: Maybe<Data> = new Data({ value: DEFAULT_STARTING_AT })
  ): number {
...
export const JOIN = {
  ...
  returns: ["STRING"],
  compute: function (delimiter: Maybe<Data>, ...valuesOrArrays: Arg[]): string {
...
export const LEFT = {
  ...
  returns: ["STRING"],
  compute: function (text: Maybe<Data>, ...args: Maybe<Data>[]): string {
...
export const LEN = {
  ...
  returns: ["NUMBER"],
  compute: function (text: Maybe<Data>): number {
...
export const MID = {
  ...
  compute: function (
    text: Maybe<Data>,
    starting_at: Maybe<Data>,
    extract_length: Maybe<Data>
  ): string {
    const _text = toString(text);
...
export const SPLIT = {
  ...
  compute: function (
    text: Maybe<Data>,
    delimiter: Maybe<Data>,
    splitByEach: Maybe<Data> = new Data({ value: SPLIT_DEFAULT_SPLIT_BY_EACH }),
    removeEmptyText: Maybe<Data> = new Data({ value: SPLIT_DEFAULT_REMOVE_EMPTY_TEXT })
  ): Matrix<string> {
    const _text = toString(text);
...
export const SUBSTITUTE = {
  ...
  compute: function (
    textToSearch: Maybe<Data>,
    searchFor: Maybe<Data>,
    replaceWith: Maybe<Data>,
    occurrenceNumber: Maybe<Data>
  ): string {
...
export const TEXT = {
  ...
  returns: ["STRING"],
  compute: function (number: Maybe<Data>, format: Maybe<Data>): string {
