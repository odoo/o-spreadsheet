...
function createGaugeChartRuntime(chart: GaugeChart, getters: Getters): GaugeChartRuntime {
  ...
  if (lowerPoint.value !== "") {
    ...
    needleInflectionPoint.push({
      value: scale(lowerPointNeedleValue, minNeedleValue, maxNeedleValue),
  ...
  if (upperPoint.value !== "") {
    ...
    needleInflectionPoint.push({
      value: scale(upperPointNeedleValue, minNeedleValue, maxNeedleValue),
  ...
  if (dataRange !== undefined) {
    cellValue = getters.getRangeValues(dataRange)[0];
