...
export function getLineChartScales(
  ...
  if (axisType === "time" && labels && labelFormat) {
    ...
    scales!.x!.ticks!.callback = definition.humanizeNumbers
  ...
  const scales: ChartScales = {
    ...
    y: {
      ...
      ticks: {
        ...
        callback: formatTickValue({ locale, format }, definition.humanizeNumbers),
      },
      grid: {
...
export function getRadarChartScales(
  ...
  return {
    r: {
      beginAtZero: true,
      ticks: {
        callback: formatTickValue({ format: axisFormats?.r, locale }, definition.humanizeNumbers),
...
function getChartAxis(
  ...
  if (type === "values") {
    ...
    return {
      ...
      ticks: {
        color: fontColor,
        callback: formatTickValue(options, definition.humanizeNumbers),
      },
    };
  } else {
    return {
