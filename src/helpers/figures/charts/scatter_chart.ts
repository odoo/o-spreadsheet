...
import {
  ...
  checkLabelRange,
  createDataSets,
  duplicateAxesDesignWithNewSheetId,
  duplicateChartTitleWithNewSheetId,
...
export class ScatterChart extends AbstractChart {
  ...
  duplicateInDuplicatedSheet(newSheetId: UID): ScatterChart {
    ...
    const updatedChartTitle = duplicateChartTitleWithNewSheetId(
      this.getters,
      this.sheetId,
      newSheetId,
      this.title,
    ...
    const updatedAxesDesign = duplicateAxesDesignWithNewSheetId(
      this.getters,
      this.sheetId,
      newSheetId,
      this.axesDesign,
