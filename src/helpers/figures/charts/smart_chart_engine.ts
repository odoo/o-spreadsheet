  ...
  switch (type) {
    case "percentage":
      return {
        ...
        dataSource: { dataSets: [{ dataRange, id: "1" }] },
        dataSets: {},
        legendPosition: "none",
        dataSetsHaveTitle,
      };
...
function buildTwoColumnChart(columns: ColumnInfo[], getters: Getters): ChartDefinition {
  ...
  if (columns[1].type === "percentage") {
    return {
      type: "pie",
      title: {},
      dataSource: { dataSets: [{ dataRange: getUnboundRange(getters, columns[1].zone), id: "1" }] },
      dataSets: {},
  ...
  if (columns[0].type === "text" && columns[1].type === "number") {
    ...
    if (uniqueCount !== totalCount) {
      return {
        ...
        title: {},
        dataSource: {
          dataSets: [{ dataRange: getUnboundRange(getters, textColumn.zone), id: "1" }],
        },
        dataSets: {},
