...
import { CalendarChartDefinition, CalendarChartGroupBy } from "../../../types/chart/calendar_chart";
import {
  AxesDesign,
...
export class CalendarChart extends AbstractChart {
  ...
  constructor(definition: CalendarChartDefinition, sheetId: UID, getters: CoreGetters) {
    ...
    this.horizontalGroupBy = definition.horizontalGroupBy ?? "weekday";
    this.verticalGroupBy = definition.verticalGroupBy ?? "hour";
