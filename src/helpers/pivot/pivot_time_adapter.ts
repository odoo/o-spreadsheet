...
import { DAYS, MONTHS, formatValue } from "../format";
...
const dayOfWeekAdapter: PivotTimeAdapterNotNull<number> = {
  ...
  toValueAndFormat(normalizedValue, locale) {
    /**
     * Normalized value is the day of week (1 based index) depending on the
     * locale week start day. We need to convert it to a 0 based index with 0
     * being Sunday.
     */
