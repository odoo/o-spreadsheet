...
import { InitPivotParams } from "../../../types/pivot_runtime";
 ...
 */
export class SpreadsheetPivotDataLayer {
   ...
   * PUBLIC?????
   */
  invalidRangeError: EvaluationError | Error | undefined;
  /**
   ...
   */
  private needsReevaluation: boolean = true;
  ...
  init(params: InitPivotParams = {}) {
    // remove this if
    if (!this._definition || params.reload || this.needsReevaluation) {
