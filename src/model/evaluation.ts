...
import { Cell, WorkBookState, Sheet } from "./state";
...
export function evaluateCells(state: WorkBookState) {
  _evaluateCells(state, false);
}

export function _evaluateCells(state: WorkBookState, onlyWaiting: boolean) {
