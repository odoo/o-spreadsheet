...
export class ChartPlugin extends CorePlugin<typeof ChartPlugin, ChartState> implements ChartState {
  ...
  adaptRanges(rangeAdapters: RangeAdapterFunctions) {
    for (const [chartId, chart] of Object.entries(this.charts)) {
      ...
      const newChart = SpreadsheetChart.fromDefinition(
        this.getters,
        chart.chart.sheetId,
  ...
  getChart(chartId: UID): SpreadsheetChart | undefined {
      ...
      if (sheet.figures) {
        for (const figure of sheet.figures) {
          ...
          if (figure.tag === "chart") {
            ...
            const chart = SpreadsheetChart.fromStrDefinition(this.getters, sheet.id, definition);
