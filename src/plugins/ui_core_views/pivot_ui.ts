...
import { deepCopy, deepEquals, getUniqueText, isDefined } from "../../helpers/misc";
import {
...
export class PivotUIPlugin extends CoreViewPlugin {
  ...
  getPivotIdsFromFormula(formula: CompiledFormula): UID[] {
  ...
  private isMainFunctionPivotSpreadFunction(cell: FormulaCell): boolean {
    return cell.compiledFormula.isFirstNonWhitespaceSymbol("PIVOT");
  }
}
