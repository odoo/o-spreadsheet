...
export class CellIconPlugin extends UIPlugin {
  ...
  handlers = {
    ...
    DELETE_NAMED_RANGE: this.clearCellIconsCache,
    RENAME_PIVOT: this.clearCellIconsCache,
    ...
    UPDATE_PIVOT: this.clearCellIconsCache,
    ...
    START: this.clearCellIconsCache,
    ...
    INSERT_NEW_PIVOT: this.clearCellIconsCache,
    ...
    UPDATE_COLOR_SCHEME: this.clearCellIconsCache,
  };
