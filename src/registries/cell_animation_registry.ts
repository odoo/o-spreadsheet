...
cellAnimationRegistry.add("textChange", {
  ...
  updateAnimation: function (progress, animatedBox, oldBox, newBox) {
    ...
    const slideInBox: Box = {
      ...
      style: { ...newBox.style, skipCellGridLines: true },
    ...
    const slideOutBox: Box = {
      ...
      width: newBox.width,
      height: newBox.height,
      style: { ...oldBox.style, skipCellGridLines: true },
  ...
  updateAnimation: function (progress, animatedBox, oldBox, newBox) {
    ...
    const animateIconChange = (side: "left" | "right" | "center") => {
      ...
      const slideInBox: Box = {
        ...
        style: { verticalAlign: newBox.style.verticalAlign, skipCellGridLines: true },
        x: newBox.x,
        y: slideInY,
        width: newBox.width,
        height: newBox.height,
      ...
      const slideOutBox: Box = {
        ...
        style: { verticalAlign: oldBox.style.verticalAlign, skipCellGridLines: true },
        x: newBox.x,
        y: slideOutY,
        width: newBox.width,
        height: newBox.height,
