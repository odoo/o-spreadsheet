...
criterionComponentRegistry.add("textContains", {
  type: "textContains",
...
criterionComponentRegistry.add("textNotContains", {
...
criterionComponentRegistry.add("textBeginsWith", {
  type: "textBeginsWith",
  component: SingleInputCriterionForm,
  category: "text",
  sequence: 25,
...
criterionComponentRegistry.add("textEndsWith", {
  type: "textEndsWith",
  component: SingleInputCriterionForm,
  category: "text",
  sequence: 26,
...
criterionComponentRegistry.add("textIs", {
  type: "textIs",
  component: SingleInputCriterionForm,
  category: "text",
  sequence: 30,
...
criterionComponentRegistry.add("textIsEmail", {
  type: "textIsEmail",
  component: undefined,
  category: "text",
  sequence: 40,
...
criterionComponentRegistry.add("textIsLink", {
  type: "textIsLink",
  component: undefined,
  category: "text",
  sequence: 50,
