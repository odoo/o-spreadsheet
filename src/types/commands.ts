...
export interface UndoSelectiveCommand extends OLDBaseCommand {
  type: "SELECTIVE_UNDO";
  id: UID;
}
...
export type Command =
  | MultiuserCommand
  | NewInputCommand //No
  | RemoveInputCommand //No
  | FocusInputCommand //No
  | AddEmptyRangeCommand //No
  | RemoveRangeCommand //No
  | ChangeRangeCommand //No
  | UpdateCellCommand //Yes -> UpdateCell
  | CopyCommand //No
  | CutCommand //No
  | PasteCommand //No
  | PasteCellCommand //No
  | AutoFillCellCommand //No
  | PasteFromOSClipboardCommand //No
  | ActivatePaintFormatCommand //No
  | ResizeRowsCommand //Yes -> ResizeRows
  | ResizeColumnsCommand //Yes -> ResizeColumns
  | AutoresizeColumnsCommand //No
  | AutoresizeRowsCommand //No
  | MovePositionCommand //No
  | CreateSheetCommand //Yes -> DeleteSheet
  | MoveSheetCommand //Yes -> MoveSheet
  | RenameSheetCommand //Yes -> RenameSheet
  | DuplicateSheetCommand //Yes -> DeleteSheet
  | DeleteSheetCommand //Yes -> CreateSheet
  | DeleteSheetConfirmationCommand //No
  | ActivateSheetCommand //No
  | StartSelectionCommand //No
  | StartExpansionCommand //No
  | PrepareExpansionCommand //No
  | StopSelectionCommand //No
  | SelectCellCommand //No
  | SetSelectionCommand //No
  | SelectColumnCommand //No
  | SelectRowCommand //No
  | SelectAllCommand //No
  | AlterSelectionCommand //No
  | DeleteContentCommand //No
  | EvaluateCellsCommand //No
  | AddConditionalFormatCommand //Yes -> RemoveConditionnalFormat
  | RemoveConditionalFormatCommand //Yes -> AddConditionnalFormat
  | AddHighlightsCommand //No
  | RemoveHighlightsCommand //No
  | RemoveAllHighlightsCommand //No
  | HighlightSelectionCommand //No
  | AddPendingHighlightCommand //No
  | ResetPendingHighlightCommand //No
  | SetColorCommand //No
  | StartComposerSelectionCommand //No
  | StopComposerSelectionCommand //No
  | StartEditionCommand //No
  | StopEditionCommand //No
  | AddMergeCommand //Yes -> RemoveMerge
  | RemoveMergeCommand //Yes -> AddMerge
  | SetCurrentContentCommand //No
  | ChangeComposerSelectionCommand //No
  | ReplaceComposerSelectionCommand //No
  | SetValueCommand //No
  | AddFormattingCommand //No
  | ClearFormattingCommand //No
  | SetFormatterCommand //No
  | SetDecimalCommand //No
  | ClearCellCommand //No
  | UndoCommand //Yes -> We can't undo an undo, it's a redo
  | UndoSelectiveCommand //Yes -> We can't undo an undo, it's a redo
  | RedoCommand //Yes -> We can't undo a redo, it's an undo
  | StartCommand //No
  | RemoveRowsCommand //Yes -> AddRows
  | RemoveColumnsCommand //Yes -> AddColumns
  | AddRowsCommand //Yes -> RemoveRows
  | CreateChartCommand //Yes -> DeleteChart
  | UpdateChartCommand //Yes -> UpdateChart
  | AddColumnsCommand //Yes -> RemoveColumns
  | AutofillCommand //No
  | AutofillSelectCommand //No
  | ShowFormulaCommand //No
  | AutofillAutoCommand //No
  | CreateFigureCommand //Yes -> DeleteFigure
  | SelectFigureCommand //No
  | UpdateFigureCommand //Yes -> UpdateFigure
  | DeleteFigureCommand; //Yes -> CreateFigure
