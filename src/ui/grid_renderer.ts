...
import { Border, Cell, GridModel, Style, Zone, ViewPortState } from "../model/index";
...
export function drawGrid(
  ...
  drawBackgrounds(state, context);
  drawBorders(state, context);
  drawTexts(state, context);
...
function drawBackgroundGrid(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawBackgrounds(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawBorders(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawTexts(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawSelection(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawActiveZone(state: ViewPortState, ctx: CanvasRenderingContext2D) {
  // const { activeZone } = state;
  // ctx.strokeStyle = "#3266ca";
  ...
  // //   };
  // // }
  // const [x, y, width, height] = getRect(activeZone, state);
  // if (width > 0 && height > 0) {
  //   ctx.strokeRect(x, y, width, height);
  // }
}
...
// function getRect(zone: Zone, state: ViewPortState): Rect {
...
function drawHighlights(state: ViewPortState, ctx: CanvasRenderingContext2D) {
  // ctx.lineWidth = 3 * thinLineWidth;
...
function drawClipBoard(state: ViewPortState, ctx: CanvasRenderingContext2D) {
...
function drawHeader(state: ViewPortState, ctx: CanvasRenderingContext2D) {
