...
import { getPastablePluginClipBoardContent } from "../../src/helpers/clipboard/clipboard_helpers";
...
describe.each(["chart", "image"])("Clipboard for %s figures", (type: string) => {
  ...
  test("Chart clipboard content is not serialized at copy", () => {
    ...
    const clipboardSpreadsheetContent = getPastablePluginClipBoardContent(
