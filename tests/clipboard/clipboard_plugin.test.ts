...
describe("clipboard", () => {
  ...
  test("hidden row are taken into account when copypasting range", () => {
    const model = createModelFromGrid({
      B2: "b2",
      C2: "c2",
      D2: "d2",
  ...
  test("hidden row are taken into account when cutpasting range", () => {
    const model = createModelFromGrid({
      B2: "b2",
      C2: "c2",
      D2: "d2",
  ...
  test("hidden columns are taken into account when copypasting range", () => {
    const model = createModelFromGrid({
      B2: "b2",
      C2: "c2",
      D2: "d2",
  ...
  test("hidden columns are taken into account when cutpasting range", () => {
    const model = createModelFromGrid({
      B2: "b2",
      C2: "c2",
      D2: "d2",
