...
describe("Collaborative local history", () => {
  ...
  test("Update chart revisions contain the full definition", () => {
    ...
    const model = new Model(data, {}, initialMessages);
    const definition1 = model.getters.chart.getDefinition("fig1") as LineChartDefinition;
    expect(definition1.dataSets).toEqual(["A1:A3"]);
    const definition2 = model.getters.chart.getDefinition("fig2") as LineChartDefinition;
