...
describe("column statistics sidePanel component", () => {
  ...
  test("Column stats side panel is correctly filled for string data", async () => {
    ...
    expect('[data-test-id="Total rows"]').toHaveText("100");
    expect('[data-test-id="Unique values"]').toHaveText("5");
    expect('[data-test-id="Sum"]').toHaveText("—");
    expect('[data-test-id="Average"]').toHaveText("—");
    expect('[data-test-id="Median"]').toHaveText("—");
    expect('[data-test-id="Minimum value"]').toHaveText("—");
    expect('[data-test-id="Maximum value"]').toHaveText("—");
  ...
  test("Column stats side panel is correctly filled for empty data", async () => {
    ...
    expect('[data-test-id="Total rows"]').toHaveText("100");
    expect('[data-test-id="Unique values"]').toHaveText("—");
    expect('[data-test-id="Sum"]').toHaveText("—");
    expect('[data-test-id="Average"]').toHaveText("—");
    expect('[data-test-id="Median"]').toHaveText("—");
    expect('[data-test-id="Minimum value"]').toHaveText("—");
    ...
    expect(".frequency-label").toHaveCount(0);
    expect(".frequency-value").toHaveCount(0);
  });
  ...
  test("String data are ignored in the column stats side panel when there is numerical data in the same column", async () => {
    ...
    expect('[data-test-id="Total rows"]').toHaveText("100");
    expect('[data-test-id="Unique values"]').toHaveText("6");
    expect('[data-test-id="Sum"]').toHaveText("60.00");
    expect('[data-test-id="Average"]').toHaveText("20.00");
    expect('[data-test-id="Median"]').toHaveText("20.00");
    expect('[data-test-id="Minimum value"]').toHaveText("10.00");
    expect('[data-test-id="Maximum value"]').toHaveText("30.00");
  ...
  test("Can ignore header cell", async () => {
    ...
    expect('[data-test-id="Unique values"]').toHaveText("4");
    const labels = Array.from(fixture.querySelectorAll(".frequency-label")).map(
      (el) => el.textContent
    );
  ...
  test("Side panel reacts to change of cell content", async () => {
    ...
    expect('[data-test-id="Sum"]').toHaveText("30.00");
  ...
  test("Side panel reacts to deletion of row", async () => {
    ...
    expect('[data-test-id="Unique values"]').toHaveText("2");
  });
