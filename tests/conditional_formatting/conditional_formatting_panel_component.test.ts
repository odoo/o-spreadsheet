...
const selectors = {
  ...
  ruleEditor: {
    ...
    editor: {
      operatorInput: ".o-cf-editor .o-cf-editor .o-cell-is-operator",
      valueInput: ".o-cf-editor .o-cf-editor .o-cf-cell-is-rule .o-composer",
      bold: ".o-cf-editor .o-cf-editor .o-sidePanel-tools div.o-menu-item-button[title='Bold']",
      italic: ".o-cf-editor .o-cf-editor .o-sidePanel-tools div.o-menu-item-button[title='Italic']",
      underline:
        ".o-cf-editor .o-cf-editor .o-sidePanel-tools div.o-menu-item-button[title='Underline']",
      strikethrough:
        ".o-cf-editor .o-cf-editor .o-sidePanel-tools div.o-menu-item-button[title='Strikethrough']",
      colorDropdown: ".o-cf-editor .o-cf-editor .o-color-picker-widget .o-color-picker-button",
      iconSetRule: {
