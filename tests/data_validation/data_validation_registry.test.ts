...
describe("Data validation registry", () => {
  ...
  beforeEach(() => {
    vi.useFakeTimers();
    vi.setSystemTime(new Date("01/01/2021 12:00:00"));
  });
  ...
  describe("Date is", () => {
    ...
    test("Last month/year work on edge cases", () => {
      ...
      // Last day of month
      vi.setSystemTime(new Date("2021-05-31 12:00:00"));
      ...
      vi.setSystemTime(new Date("2021-03-30 12:00:00"));
      testCriterion.dateValue = "lastMonth";
      ...
      // // Last day of year
      vi.setSystemTime(new Date("2021-12-31 12:00:00"));
      ...
      vi.setSystemTime(new Date("2020-02-29 12:00:00"));
      testCriterion.dateValue = "lastYear";
