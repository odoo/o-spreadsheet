...
describe("datasource tests", function () {
  ...
  test("remove labels from existing chart", () => {
    ...
    updateChartDataSource(model, "1", { labelRanges: undefined });
    expect(getChartDataSource(model, "1")?.labelRanges?.[0]).toBeUndefined();
  });
      ...
      sheets: [
        {
          id: "sh1",
          figures: [
            { ...figure, data: { type: "line", dataSets: [], labelRanges: ["A1:A2"] } },
            { ...figure, data: { type: "line", dataSets: [], labelRanges: ["A1:A2"] } },
          ],
        },
      ],
  ...
  test("create chart with invalid labels", () => {
    const result = createChart(
      model,
      {
        ...toChartDataSource({
          dataSets: [{ dataRange: "Sheet1!B1:B4" }],
          labelRanges: ["Miaouss oui la guerre"],
        }),
        type: "line",
      },
      "1"
  ...
  test("update chart with invalid labels", () => {
    ...
    expect(
      updateChartDataSource(model, "1", { labelRanges: ["This is invalid"] })
    ...
    createChart(
      model,
      {
        ...
        ...toChartDataSource({
          ...
          labelRanges: [`${secondSheetName}!A2:A4`],
        }),
      },
      firstSheetId
    );
...
describe("Chart without labels", () => {
  ...
  test("The legend is not displayed if there is no label for pie charts", () => {
    ...
    createChart(
      model,
      { ...pieChart, ...toChartDataSource({ ...pieChart.dataSource, labelRanges: ["B1:B2"] }) },
      "44"
    );
...
describe("Chart design configuration", () => {
  ...
  test("value without matching index in the label set", () => {
    ...
    createChart(
      ...
      {
        type: "bar",
        ...toChartDataSource({ labelRanges: ["A2:A3"], dataSets: [{ dataRange: "B1:B15" }] }),
      },
      "1"
    );
    const data = getChartConfiguration(model, "1").data;
  ...
  test("label without matching index in the data set", () => {
    ...
    createChart(
      ...
      {
        type: "bar",
        ...toChartDataSource({ labelRanges: ["A2:A15"], dataSets: [{ dataRange: "B1:B3" }] }),
      },
      "1"
    );
    const data = getChartConfiguration(model, "1").data;
  ...
  test("no data points at all", () => {
    ...
    createChart(
      ...
      {
        type: "bar",
        ...toChartDataSource({ labelRanges: ["A2:A3"], dataSets: [{ dataRange: "B1:B3" }] }),
      },
      "1"
    );
    const data = getChartConfiguration(model, "1").data;
  ...
  describe("Pie Chart tooltip", () => {
    test("pie chart tooltip label to include percentage", () => {
      ...
      createChart(
        model,
        {
          ...toChartDataSource({ dataSets: [{ dataRange: "A1:A3" }], labelRanges: ["A1"] }),
          type: "pie",
        },
        "1"
      );
    ...
    test("pie chart tooltip label with format", () => {
      ...
      createChart(
        model,
        {
          ...toChartDataSource({ dataSets: [{ dataRange: "A1:A2" }], labelRanges: ["A1"] }),
          type: "pie",
          humanize: false,
        },
        "1"
  ...
  test("scatter chart trend line tooltip label", () => {
    ...
    createChart(
      model,
      {
        ...toChartDataSource({
          dataSets: [
            { dataRange: "B1:B2", trend: { type: "polynomial", order: 1, display: true } },
          ],
          labelRanges: ["A1:A2"],
          dataSetsHaveTitle: false,
        }),
  ...
  test.each(["line", "bar", "combo"] as const)(
    ...
    (chartType) => {
      ...
      createChart(
        model,
        {
          ...toChartDataSource({ dataSets: [{ dataRange: "A1:A2", yAxisId: "y" }] }),
          type: chartType,
        },
        "43"
      );
...
describe("Linear/Time charts", () => {
  ...
  test("linear axis for line chart with numbers labels/dataset", () => {
    createChart(
      ...
      {
        type: "line",
        ...toChartDataSource({ dataSets: [{ dataRange: "B2:B5" }], labelRanges: ["C2:C5"] }),
        labelsAsText: false,
      },
      chartId
    );
  ...
  test("time axis: the axis unit are correct", () => {
    createChart(
      ...
      {
        type: "line",
        ...toChartDataSource({ dataSets: [{ dataRange: "B2:B5" }], labelRanges: ["C2:C3"] }),
        labelsAsText: false,
      },
      chartId
    );
...
describe("Chart evaluation", () => {
  ...
  test("undo/redo invalidates the chart runtime", () => {
    ...
    updateChartDataSource(model, chartId, { labelRanges: ["A1:A2"] });
...
describe("Pie chart invalid values", () => {
  test("Pie chart to exclude negative values and labels in single dataset", () => {
    ...
    createChart(
      model,
      {
        ...toChartDataSource({ dataSets: [{ dataRange: "D5:D10" }], labelRanges: ["A2:A6"] }),
        type: "pie",
      },
      "1"
    );
  ...
  test("Zeros values are removed from the pie chart", () => {
    ...
    createChart(
      model,
      { ...toChartDataSource({ dataSets: [{ dataRange: "F5:F8" }] }), type: "pie" },
      "1"
    );
  ...
  test("Non-number values are removed from the pie chart", () => {
    ...
    createChart(
      model,
      {
        ...toChartDataSource({ dataSets: [{ dataRange: "F5:F8" }], labelRanges: ["G5:G8"] }),
        type: "pie",
      },
      "1"
    );
...
test("Duplicating a sheet dispatches CREATE_CHART for each chart", () => {
  createChart(
    model,
    {
      ...toChartDataSource({ dataSets: [{ dataRange: "D5:D10" }, { dataRange: "E5:E10" }] }),
      type: "bar",
    },
    "24"
  );
  ...
  beforeEach(() => {
    ...
    createChart(
      model,
      {
        ...toChartDataSource({
          dataSets: [
            { dataRange: "B1:B5", trend: { display: true, type: "polynomial", order: 2 } },
          ],
          labelRanges: ["C1:C5"],
          dataSetsHaveTitle: false,
        }),
...
describe("Chart labels truncation", () => {
  ...
  test("Moving average trend line dataset uses the right axis when combined with other datasets", () => {
    ...
    updateChartDataSource(model, "1", { labelRanges: ["C1:C5"] });
    runtime = model.getters.getChartRuntime("1") as LineChartRuntime;
    // @ts-ignore
    expect(runtime.chartJsConfig.data.datasets[3].xAxisID).toEqual("xMovingAverage");
    expect(scales.xMovingAverage!["display"]).toEqual(false);
    ...
    updateChartDataSource(model, "1", { labelRanges: ["A1:A5"] });
    runtime = model.getters.getChartRuntime("1") as LineChartRuntime;
    // @ts-ignore
    expect(runtime.chartJsConfig.data.datasets[3].xAxisID).toEqual("xMovingAverage");
    expect(scales.xMovingAverage!["display"]).toEqual(false);
    ...
    updateChartDataSource(model, "1", { labelRanges: ["B1:B5"] });
  ...
  test.each(["bar", "line", "combo", "radar"] as const)(
    ...
    (type) => {
      ...
      createChart(
        ...
        {
          type,
          ...toChartDataSource({ dataSets: [{ dataRange: "B1:B2" }], dataSetsHaveTitle: true }),
        },
        "chartId"
      );
...
describe("Chart highlighting", () => {
  test.each(["line", "scatter"] as const)(
    ...
    (chartType) => {
      ...
      expect(config.data?.datasets![0].borderColor).toEqual("#4EA7F2");
      expect(config.data?.datasets![0].pointBackgroundColor).toEqual("#4EA7F2");
      expect(config.data?.datasets![1].borderColor).toEqual("#EA617533");
      expect(config.data?.datasets![1].pointBackgroundColor).toEqual("#EA617533");

      config.options.plugins.legend.onHover({}, { datasetIndex: 1 }, legend);
      expect(config.data?.datasets![0].borderColor).toEqual("#4EA7F233");
      expect(config.data?.datasets![0].pointBackgroundColor).toEqual("#4EA7F233");
      expect(config.data?.datasets![1].borderColor).toEqual("#EA6175");
      expect(config.data?.datasets![1].pointBackgroundColor).toEqual("#EA6175");
  ...
  test("area chart correctly highlights datasets on legend hover", () => {
    ...
    expect(config.data?.datasets![0].backgroundColor).toEqual("#4EA7F266");
    expect(config.data?.datasets![1].borderColor).toEqual("#EA617533");
    expect(config.data?.datasets![1].backgroundColor).toEqual("#EA617514");

    config.options.plugins.legend.onHover({}, { datasetIndex: 1 }, legend);
    expect(config.data?.datasets![0].borderColor).toEqual("#4EA7F233");
    expect(config.data?.datasets![0].backgroundColor).toEqual("#4EA7F214");
    expect(config.data?.datasets![1].borderColor).toEqual("#EA6175");
    expect(config.data?.datasets![1].backgroundColor).toEqual("#EA617566");
  ...
  test("bar chart correctly highlights datasets on legend hover", () => {
    ...
    config.options.plugins.legend.onHover({}, { datasetIndex: 0 }, legend);
    expect(config.data?.datasets![0].backgroundColor).toEqual("#4EA7F2");
    expect(config.data?.datasets![1].backgroundColor).toEqual("#EA617533");
    ...
    config.options.plugins.legend.onHover({}, { datasetIndex: 1 }, legend);
    expect(config.data?.datasets![0].backgroundColor).toEqual("#4EA7F233");
    expect(config.data?.datasets![1].backgroundColor).toEqual("#EA6175");
  });
...
describe("data ordering with groupByParentCategories", () => {
  beforeEach(() => {
    // prettier-ignore
  ...
  test("labels keep dataset order without groupByParentCategories", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    expect(getChartConfiguration(model, "1").data.labels).toEqual(["Q2", "Q1", "Q1", "Q3", "Q2"]);
  });

  test("rows are reordered to group by the outermost label with groupByParentCategories", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    expect(getChartConfiguration(model, "1").data.labels).toEqual(["Q2", "Q1", "Q3", "Q1", "Q2"]);
  });

  test("secondary labels are rebuilt sparsely after grouping", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    const secondary = getChartConfiguration(model, "1").options?.plugins?.chartGroupedLabelsPlugin
      ?.parentCategories;
    expect(secondary).toHaveLength(1);
    expect(secondary![0]).toEqual(["2024", "2024", "2024", "2023", "2023"]);
  });

  test("dataset values are reordered consistently with labels", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    expect(getChartConfiguration(model, "1").data.datasets[0].data).toEqual([40, 30, 50, 10, 20]);
  });

  test("groupByParentCategories has no effect with only one label range", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    const config = getChartConfiguration(model, "1");
    expect(config.data.labels).toEqual(["Q2", "Q1", "Q1", "Q3", "Q2"]);
    expect(config.options?.plugins?.chartGroupedLabelsPlugin?.parentCategories).toBeUndefined();
  });

  test("groupByParentCategories preserves original order within a group", () => {
    createChart(
      model,
      {
        type: "bar",
    ...
    const labels = getChartConfiguration(model, "1").data.labels;
    expect(labels.slice(0, 3)).toEqual(["Q2", "Q1", "Q3"]);
  });
});
