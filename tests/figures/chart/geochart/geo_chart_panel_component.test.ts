...
describe("Geo chart side panel", () => {
  ...
  describe("Design panel", () => {
    test("Geo design panel is correctly initialized", async () => {
      ...
      const classList = fixture.querySelector(".o-color-scale .colormap-preview")?.classList;
      expect(classList).toContain("purples-colormap");
    });
    ...
    test("Can edit the color scale", async () => {
      ...
      await click(fixture, ".colormap-container");
      await click(fixture, ".colormap-preview.oranges-colormap");
      expect(getGeoChartDefinition(chartId)?.colorScale).toEqual("oranges");
      expect(".o-color-scale .colormap-preview").toHaveClass("oranges-colormap");
    });
    ...
    test("Can edit a custom color scale", async () => {
      ...
      await click(fixture, ".colormap-container");
      await click(fixture, ".colormap-preview.custom-colormap");
