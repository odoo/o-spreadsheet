...
describe("Scorecard chart side panel", () => {
  ...
  test("error displayed on input fields", async () => {
    const model = new Model();
    ...
    expect(document.querySelector(".o-data-series .o-standalone-composer")).toHaveClass(
      "o-invalid"
    );
    expect(document.querySelector(".o-data-labels .o-standalone-composer")).not.toHaveClass(
      "o-invalid"
    );
    ...
    expect(document.querySelector(".o-data-labels .o-standalone-composer")).toHaveClass(
      "o-invalid"
    );
  });
