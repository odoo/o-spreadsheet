...
describe("Waterfall chart side panel", () => {
  ...
  describe("Design panel", () => {
    test("Waterfall design panel is correctly initialized", async () => {
      ...
      expect(getRoundColorPickerColor(".o-waterfall-positive-color")).toEqual("#0000FF");
      expect(getRoundColorPickerColor(".o-waterfall-negative-color")).toEqual("#FFFF00");
      expect(getRoundColorPickerColor(".o-waterfall-subtotal-color")).toEqual("#FF0000");
    });
