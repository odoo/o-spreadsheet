...
describe("COLUMN formula", () => {
  ...
  test("functional tests on range arguments with invalid sheet name", () => {
    ...
    expect(evaluateCell("A1", { A1: "=COLUMN(Sheet42!$ABC$2)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=COLUMN(Sheet42!D3:Z9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=COLUMN(Sheet42!$D$3:$Z$9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
  });
});
...
describe("COLUMNS formula", () => {
  ...
  test("functional tests on range arguments with invalid sheet name", () => {
    ...
    expect(evaluateCell("A1", { A1: "=COLUMNS(Sheet42!$ABC$2)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=COLUMNS(Sheet42!D3:Z9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=COLUMNS(Sheet42!$D$3:$Z$9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
  });
});
...
describe("ROW formula", () => {
  ...
  test("functional tests on range arguments with invalid sheet name", () => {
    ...
    expect(evaluateCell("A1", { A1: "=ROW(Sheet42!$A$234)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=ROW(Sheet42!D3:Z9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=ROW(Sheet42!$D$3:$Z$9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
  });
});
...
describe("ROWS formula", () => {
  ...
  test("functional tests on range arguments with invalid sheet name", () => {
    ...
    expect(evaluateCell("A1", { A1: "=ROWS(Sheet42!$ABC$2)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=ROWS(Sheet42!D3:Z9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
    expect(evaluateCell("A1", { A1: "=ROWS(Sheet42!$D$3:$Z$9)" })).toBe("#ERROR"); // @compatibility: on google sheets, return #REF!
  });
});
