...
describe("DROP formula", () => {
  test("correct for one row", () => {
    ...
    const expectedResult = { D5: "A2", E5: "B2" };
    expect(evaluateGrid(grid)).toMatchObject(expectedResult);
  });
  test("correct for one column", () => {
    ...
    const expectedResult = { D5: "B1", D6: "B2" };
    expect(evaluateGrid(grid)).toMatchObject(expectedResult);
  });
  test("correct for -1 column", () => {
    ...
    const expectedResult = { D5: "A1", D6: "A2" };
    expect(evaluateGrid(grid)).toMatchObject(expectedResult);
  });
  test("correct for -1 row", () => {
    ...
    const expectedResult = { D5: "A1", E5: "B1" };
    expect(evaluateGrid(grid)).toMatchObject(expectedResult);
  });
...
describe("TAKE formula", () => {
  ...
  test("all rows if too many rows to take", () => {
    ...
    const expectedResult = { D5: "A1", E5: "B1", D6: "A2", E6: "B2" };
    expect(evaluateGrid(grid)).toMatchObject(expectedResult);
  });
