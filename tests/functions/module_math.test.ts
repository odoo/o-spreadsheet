...
describe("COUNTIF formula", () => {
  ...
  test("COUNTIF doesn't accept errors in first parameter", () => {
    // prettier-ignore
    const grid = {
      A1: "=KABOUM", B1: "42",
      A2: "42",      B2: "=1/0", 
...
describe("COUNTIFS formula", () => {
  ...
  // @compatibility: should be able to accept errors !
  test("COUNTIFS doesn't accept errors in 2n+1 parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "=KABOUM", B1: "42",
      A2: "42",      B2: "=1/0", 
  ...
  // @compatibility: should be able to count errors !
  test("COUNTIFS doesn't accept errors on 2n parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "40", B1: "41",
      A2: "42", B2: "43", 
...
describe("COUNTUNIQUEIFS formula", () => {
  ...
  // @compatibility: should be able to accept errors !
  test("COUNTUNIQUEIFS doesn't accept errors in 2n+2 parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "40", B1: "1",
      A2: "41", B2: "1",
  ...
  // @compatibility: should be able to count errors !
  test("COUNTUNIQUEIFS doesn't accept errors on 2n+3 parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "40", B1: "1",
      A2: "41", B2: "1",
...
describe("PRODUCT formula", () => {
  ...
  test("PRODUCT doesn't accept error in values", () => {
...
describe("SUM formula", () => {
  ...
  test("SUM doesn't accept error in values", () => {
...
describe("SUMIF formula", () => {
  ...
  // @compatibility: should be able to accept errors !
  test("SUMIF doesn't accept errors in first parameter", () => {
    // prettier-ignore
    const grid = {
        A1: "=KABOUM", B1: "42",
        A2: "42",      B2: "=1/0", 
  ...
  // @compatibility: should be able to accept errors !
  test("SUMIF doesn't accept error on second parameter", () => {
    // prettier-ignore
    const grid = {
        A1: "40", B1: "42",
        A2: "41", B2: "43", 
...
describe("SUMIFS formula", () => {
  ...
  // @compatibility: should be able to accept errors !
  test("SUMIFS doesn't accept errors in 2n+2 parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "40", B1: "1",
      A2: "41", B2: "1",
  ...
  // @compatibility: should be able to count errors !
  test("SUMIFS doesn't accept errors on 2n+3 parameters", () => {
    // prettier-ignore
    const grid = {
      A1: "40", B1: "1",
      A2: "41", B2: "1",
