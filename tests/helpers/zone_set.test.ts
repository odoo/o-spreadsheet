...
describe("ZoneSet", () => {
  ...
  test("add and remove single unbounded zone: B2:3", () => {
    ...
    expect(set.has(toUnboundedZone("B2"))).toBe(true);
    expect(set.has(toUnboundedZone("Z3"))).toBe(true);
    expect(set.has(toUnboundedZone("B2:Z3"))).toBe(true);
    expect(set.has(toUnboundedZone("Z2:3"))).toBe(true);
    set.delete(toUnboundedZone("B2:3"));
    expect(set.has(toUnboundedZone("B2"))).toBe(false);
    expect(set.has(toUnboundedZone("Z3"))).toBe(false);
    expect(set.has(toUnboundedZone("B2:Z3"))).toBe(false);
    expect(set.has(toUnboundedZone("Z2:3"))).toBe(false);
    expect(Array.from(set)).toEqual([]);
  });
  ...
  test("add and remove single unbounded zone: B2:C", () => {
    ...
    expect(set.has(toUnboundedZone("B2"))).toBe(true);
    expect(set.has(toUnboundedZone("C100"))).toBe(true);
    expect(set.has(toUnboundedZone("B2:C100"))).toBe(true);
    expect(set.has(toUnboundedZone("B100:C"))).toBe(true);
    set.delete(toUnboundedZone("B2:C"));
    expect(set.has(toUnboundedZone("B2"))).toBe(false);
    expect(set.has(toUnboundedZone("C100"))).toBe(false);
    expect(set.has(toUnboundedZone("B2:C100"))).toBe(false);
    expect(set.has(toUnboundedZone("B100:C"))).toBe(false);
    expect(Array.from(set)).toEqual([]);
  });
  ...
  test("add and remove single unbounded zone: B:C", () => {
    ...
    expect(set.has(toUnboundedZone("B2"))).toBe(true);
    expect(set.has(toUnboundedZone("C3"))).toBe(true);
    expect(set.has(toUnboundedZone("B2:B3"))).toBe(true);
    expect(set.has(toUnboundedZone("C2:C"))).toBe(true);
    expect(set.has(toUnboundedZone("C:C"))).toBe(true);
    set.delete(toUnboundedZone("B:C"));
    expect(set.has(toUnboundedZone("B2"))).toBe(false);
    expect(set.has(toUnboundedZone("C3"))).toBe(false);
    expect(set.has(toUnboundedZone("B2:B3"))).toBe(false);
    expect(set.has(toUnboundedZone("C2:C"))).toBe(false);
    expect(set.has(toUnboundedZone("C:C"))).toBe(false);
    expect(Array.from(set)).toEqual([]);
  });
  ...
  test("add and remove single unbounded zone: 2:3", () => {
    ...
    expect(set.has(toUnboundedZone("C3"))).toBe(true);
    expect(set.has(toUnboundedZone("B2:B3"))).toBe(true);
    expect(set.has(toUnboundedZone("C2:3"))).toBe(true);
    expect(set.has(toUnboundedZone("3:3"))).toBe(true);
    set.delete(toUnboundedZone("2:3"));
    expect(set.has(toUnboundedZone("B2"))).toBe(false);
    expect(set.has(toUnboundedZone("C3"))).toBe(false);
    expect(set.has(toUnboundedZone("B2:B3"))).toBe(false);
    expect(set.has(toUnboundedZone("C2:3"))).toBe(false);
    expect(set.has(toUnboundedZone("3:3"))).toBe(false);
    expect(Array.from(set)).toEqual([]);
  });
  ...
  test("removing a part of a unbounded zone", () => {
    ...
    expect(set.has(toUnboundedZone("C2"))).toBe(true);
    expect(set.has(toUnboundedZone("D3"))).toBe(false);
    expect(set.has(toUnboundedZone("E4"))).toBe(true);
  ...
  test("overlap two zones but not contained", () => {
    ...
    expect(set.has(toZone("A2:A6"))).toBe(false);
  });
});
