...
describe("overlap", () => {
  ...
  test("1 vertically unbounded zone", () => {
    const z1 = { top: 0, right: 0, bottom: undefined, left: 0 };
    const z2 = { top: 3, right: 0, bottom: 5, left: 0 };
  ...
  test("2 vertically unbounded zone", () => {
    const z1 = { top: 0, right: 0, bottom: undefined, left: 0 };
    const z2 = { top: 3, right: 0, bottom: undefined, left: 0 };
    expect(overlap(z1, z2)).toBe(true);
    expect(overlap(z2, z1)).toBe(true);
  });

  test("1 vertically unbounded zone", () => {
    const z1 = { top: 4, right: undefined, bottom: 4, left: 0 };
    const z2 = { top: 3, right: 0, bottom: 5, left: 0 };
    expect(overlap(z1, z2)).toBe(true);
    expect(overlap(z2, z1)).toBe(true);
  });
  ...
  test("2 vertically unbounded zone", () => {
    const z1 = { top: 4, right: undefined, bottom: 4, left: 0 };
    const z2 = { top: 3, right: undefined, bottom: 5, left: 0 };
    expect(overlap(z1, z2)).toBe(true);
    expect(overlap(z2, z1)).toBe(true);
  });
  ...
  test("vertical and horizontal", () => {
    const z1 = { top: 5, right: undefined, bottom: 5, left: 0 };
    const z2 = { top: 0, right: 5, bottom: undefined, left: 5 };
    expect(overlap(z1, z2)).toBe(true);
    expect(overlap(z2, z1)).toBe(true);
  });
});
