...
describe("Migrations", () => {
  ...
  // TODO: test has always been wrong (it creates a figure with figure.type instead of figure.tag). Will be fixed in task 5008468
  test.skip.each(FORBIDDEN_SHEETNAME_CHARS)("migrate version 7: sheet Names", (char) => {
    const model = new Model({
      version: 7,
      sheets: [
        { name: "My sheet" },
