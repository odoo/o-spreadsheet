...
describe("Pivot fix formula menu item", () => {
  ...
  test("it converts the pivot style to a static table, and remove any dynamic table on the pivot", async () => {
    // prettier-ignore
    const grid = {
  ...
  test("It should not fix formula when the pivot is not valid", async () => {
    // prettier-ignore
    const grid = {
      A1: "Customer", B1: "Price", C1: "=PIVOT(1)",
      A2: "Alice",    B2: "10",
...
describe("Pivot reinsertion menu item", () => {
  describe("Dynamic pivots", () => {
    test("Reinsert a dynamic pivot", async () => {
      // prettier-ignore
      const grid = {
    ...
    test("Reinsert a dynamic pivot in a sheet too small", async () => {
      // prettier-ignore
      const grid = {
            A1: "Customer", B1: "Quantity",
            A2: "Alice",    B2: "Jambon",
    ...
    test("undo pivot reinsertion", async () => {
      // prettier-ignore
      const grid = {
            A1: "Customer", B1: "Quantity",
            A2: "Alice",    B2: "Jambon",
  ...
  describe("Static pivots", () => {
    test("Reinsert a static pivot", async () => {
      // prettier-ignore
      const grid = {
            A1: "Customer", B1: "Quantity",
            A2: "Alice",    B2: "Jambon",
    ...
    test("Reinsert a static pivot in a sheet too small", async () => {
      // prettier-ignore
      const grid = {
            A1: "Customer", B1: "Quantity",
            A2: "Alice",    B2: "Jambon",
    ...
    test("Cannot reinsert a static pivot with too many pivot cells", async () => {
      const grid = { A1: "Customer", B1: "Quantity", A2: "Alice", B2: "Jambon" };
      const model = await createModelFromGrid(grid);
      addPivot(model, "A1:B2", {});

      const notifyUser = jest.fn();
      const env = await makeTestEnv({ model, notifyUser });
  ...
  test("Reinsert pivot menu item should be hidden if the pivot is invalid", async () => {
    // prettier-ignore
    const grid = {
          A1: "", B1: "Quantity",
          A2: "Alice",    B2: "Jambon",
  ...
  test("Verify re-insert pivot menu items invisibility when no pivots present", async () => {
...
describe("Pivot sorting menu item", () => {
  ...
  beforeEach(async () => {
    model = await createModelWithTestPivotDataset();
...
describe("Pivot (un)grouping menu items", () => {
  ...
  describe("Group pivot headers", () => {
    ...
    test("Can merge two existing groups", async () => {
    ...
    test("Merging a group into others group will remove the group", async () => {
      updatePivotWithGroups([
        { name: "MyGroup", values: ["New", "Won"] },
  ...
  describe("Ungroup pivot headers", () => {
    ...
    test("Removing all groups deletes the custom field, and its occurrences in the pivot dimensions", async () => {
      updatePivotWithGroups([
        { name: "MyGroup", values: ["New", "Won"] },
        { name: "Others", values: [], isOtherGroup: true },
      ]);
    ...
    test("The deleted custom field is replaced with its parent field if it wasn't present in the pivot", async () => {
      updatePivot(model, pivotId, {
    ...
    test("Can remove the others group", async () => {
      updatePivotWithGroups([
        { name: "MyGroup", values: ["New", "Won"] },
        { name: "Others", values: [], isOtherGroup: true },
      ]);
  ...
  describe("Group remaining pivot headers", () => {
    ...
    test("Removing all groups deletes the custom field", async () => {
      updatePivotWithGroups([
        { name: "MyGroup", values: ["New", "Won"] },
        { name: "Others", values: [], isOtherGroup: true },
      ]);
