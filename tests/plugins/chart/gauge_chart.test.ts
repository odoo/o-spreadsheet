...
describe("datasource tests", function () {
  test("create a gauge chart", () => {
    ...
    expect(model.getters.chart.getDefinition("1") as GaugeChartDefinition).toMatchObject({
      dataRange: "B8",
      type: "gauge",
      title: "Title",
      sectionRule: randomSectionRule,
  ...
  test("ranges in gauge definition change automatically", () => {
    ...
    const chart = model.getters.chart.getDefinition("1") as GaugeChartDefinition;
...
describe("multiple sheets", () => {
  ...
  test("create a gauge chart with data from another sheet", () => {
    ...
    const chart = model.getters.chart.getDefinition("28") as GaugeChartDefinition;
