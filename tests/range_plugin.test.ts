...
import { duplicateRangeInDuplicatedSheet, numberToLetters, zoneToXc } from "../src/helpers";
...
describe("range plugin", () => {
  ...
  describe("restoring a range as string", () => {
    ...
    test("can create a range without giving a defaultSheetId only if a sheet name is in the XC", () => {
