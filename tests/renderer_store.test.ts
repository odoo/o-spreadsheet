...
describe("renderer", () => {
  ...
  test("horizontal align on pivot header", () => {
    let box: Box;
    const pivotModel = createModelWithTestPivot();
    ...
    let contex2D = new MockGridRenderingContext(model, 1000, 1000, {});
    drawGridRenderer(contex2D);
    box = getBoxFromText(gridRendererStore, "Alice");
          ...
          sheets: [
            {
              ...
              rowNumber: 1,
              cols: { 1: { size: 5 } },
              cells: { B1: { content: overflowingContent } },
              styles: { B1: 1 },
            },
          ],
          styles: { 1: { align: "left" } },
          ...
          sheets: [
            {
              ...
              rowNumber: 1,
              cols: { 1: { size: 5 } },
              cells: { B1: { content: overflowingNumber } },
              styles: { B1: 1 },
            },
          ],
          styles: { 1: style },
        ...
        sheets: [
          {
            ...
            rowNumber: 1,
            cols: { 1: { size: 5 } },
            cells: { B1: { content: overflowingText } },
            styles: { B1: 1 },
          },
        ],
        ...
        sheets: [
          {
            ...
            cells: { C1: { content: overflowingContent }, A1: { content: "left" } },
            styles: { C1: 1 },
          },
        ],
        ...
        sheets: [
          {
            ...
            cells: { C1: { content: overflowingContent }, E1: { content: "right" } },
            styles: { C1: 2 },
          },
        ],
        ...
        sheets: [
          {
            ...
            rowNumber: 5,
            cols: { 1: { size: 5 } },
            cells: { B2: { content: overflowingText } },
            styles: { B2: 1 },
            merges,
          },
        ],
        ...
        sheets: [
          {
            ...
            cells: { A1: { content: overflowingText } },
            styles: { A1: 1 },
          },
        ],
        styles: { 1: { fontSize } },
