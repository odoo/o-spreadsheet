...
describe("Spreadsheet print rendering", () => {
  ...
  test("Cannot print the selection if multiple zones are selected", async () => {
    ...
    await simulateClick(".o-print-selection");
    expect(`.o-popover .o-select-option[data-id="selection"]`).toHaveCount(0);
  });
