...
async function startRelease() {
  ...
  log(`Step 2/${STEPS}: checkout master...`);
  const resultCheckoutMaster = await execCommand("git checkout master && git pull --rebase");
  if (resultCheckoutMaster !== 0) {
    log("Git checkout failed. Aborting.");
    return;
  }
  // ---------------------------------------------------------------------------
  log(`Step 3/${STEPS}: running tests...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 4/${STEPS}: updating package.json...`);
  await replaceInFile("./package.json", current, next);

  // ---------------------------------------------------------------------------
  log(`Step 5/${STEPS}: creating branch...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 6/${STEPS}: creating git commit...`);
  ...
  // ----------------------------------------------------------------------------
  log(`Step 7/${STEPS}: building o-spreadsheet...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 8/${STEPS}: pushing on github...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 9/${STEPS}: creating a PR...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 10/${STEPS}: Creating the release...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 11/${STEPS}: deleting gh-pages...`);
  await execCommand(`git branch -D ${ghPagesBranch}`);

  // ---------------------------------------------------------------------------
  log(`Step 12/${STEPS}: checkout branch...`);
  ...
  // ---------------------------------------------------------------------------
  log(`Step 15/${STEPS}: pushing on github...`);
